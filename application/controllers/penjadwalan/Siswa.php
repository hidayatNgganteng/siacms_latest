...
class Siswa extends CI_Controller
{
    ...
    public function jadwaltambahan_siswa()
    {
		...
		$data['siswa'] = $this->mod_siswa->getinfosiswa($this->session->nisn);
        ...
        $setting = $this->setting_model->getsetting();
        $id_tahun_ajaran = $setting->id_tahun_ajaran;
        //print_r( $data['siswa']);die(); // 'kelas_tambahan.nama_kelas_tambahan' => $data['siswa']->nama_kelas,
        $data['tabel_jadwaltambahan'] = $this->mod_jadwaltambahan->get(array( 'jadwal_tambahan.id_kelas_tambahan' => $data['siswa']->id_kelas_reguler, "jadwal_tambahan.id_tahun_ajaran" => $id_tahun_ajaran));
        //print_r( $data['tabel_jadwaltambahan']);die();
