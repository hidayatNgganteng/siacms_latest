...
class Mod_jammengajar extends CI_Model {
	...
	public function get($where = array()){
		$this->db->select('jam_mengajar.*, pegawai.Nama, namamapel.nama_mapel, namamapel.warna, pegawai.kode_guru, 
			pegawai.Golongan, pegawai.pangkat, pegawai.Pendidikan, pegawai.nama_panggilan ');
