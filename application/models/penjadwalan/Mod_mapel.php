...
class Mod_mapel extends CI_Model {
	...
	public function getgroupbyjenjang(){
		$this->db->select('mapel.id_mapel AS mapel_id_key, mapel.id_namamapel, namamapel.nama_mapel as nama_mapel,mapel.kkm,mapel.jam_belajar,mapel.id_tahun_ajaran, kelas_reguler.jenjang, kelas_reguler.id_kelas_reguler');
		$this->db->join('namamapel', 'namamapel.id_namamapel=mapel.id_namamapel', 'left');
		...
		$this->db->order_by('namamapel.nama_mapel,mapel.id_namamapel, mapel.kkm,mapel.jam_belajar,mapel.id_tahun_ajaran, kelas_reguler.jenjang');
		return $this->db->get('mapel')->result();
	}
