...
class M_data extends CI_Model{
	...
	function getKelasRegulerBerjalan($id_tahun_ajaran){
		return $this->db->query("SELECT * FROM kelas_reguler_berjalan k 
		JOIN kelas_reguler r ON k.id_kelas_reguler=r.id_kelas_reguler WHERE k.id_tahun_ajaran = '$id_tahun_ajaran'");
	}
