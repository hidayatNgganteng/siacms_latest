            ...
            <div id="myTabContent" class="tab-content">
              ...
              <div class="active tab-pane" id="tab_content2" aria-labelledby="profile-tab">
                ...
                <form class="form-horizontal form-mapel" method="post">
                  <div class="bigbox-mapel"> 
                    ...
                    <tbody>
                      ...
                      for($i=0;$i<=11;$i++)  {
                        ...
                        <tr>
                          ...
                          <td class="putih">
                            ...
                            foreach (@$tabel_jadwalprioritas_senin[$i] as $rowjadwalprioritas) {
                              ...
                              if ($ada == false) {
                                if ((@$tabel_jadwalmapel_senin[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjadwalprioritas->NIP) 
                                && (@$tabel_jadwalmapel_senin[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjadwalprioritas->id_namamapel)) {
                                  echo '<th bgcolor="'.@$rowjadwalprioritas->warna.'">'.$rowjadwalprioritas->Nama."(".$rowjadwalprioritas->nama_panggilan.")".'</th>'; 
                                  $sudah = true;
                              }
                            }
                          }
                          ...
                          foreach (@$tabel_jammengajar as $rowjammengajar) {
                            ...
                            if ($ada == false) {
                              if ((@$tabel_jadwalmapel_senin[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) 
                                  && (@$tabel_jadwalmapel_senin[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { 
                                    echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama_mapel."(".$rowjammengajar->nama_panggilan.")".'</th>';  
                                    $sudah = true;
                            }
                          }
                        }
                        ...
                        <td class="putih">
                          ...
                          foreach (@$tabel_jadwalprioritas_selasa[$i] as $rowjadwalprioritas) {
                            ...
                            if ($ada == false) {
                              if ((@$tabel_jadwalmapel_selasa[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjadwalprioritas->NIP) 
                                && (@$tabel_jadwalmapel_selasa[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjadwalprioritas->id_namamapel)) { 
                                  echo '<th bgcolor="'.@$rowjadwalprioritas->warna.'">'.$rowjadwalprioritas->Nama."(".$rowjadwalprioritas->nama_panggilan.")".'</th>'; 
                            }
                          }
                        }
                        ...
                        foreach (@$tabel_jammengajar as $rowjammengajar) {
                          ...
                          if ($ada == false) {
                            if ((@$tabel_jadwalmapel_selasa[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_selasa[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) {                              
                              echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama_mapel."(".$rowjammengajar->nama_panggilan.")".'</th>';  
                          }
                        }
                      }
                      ...
                      <td class="putih">
                        ...
                        foreach (@$tabel_jadwalprioritas_rabu[$i] as $rowjadwalprioritas) {
                          ...
                          if ($ada == false) {
                            if ((@$tabel_jadwalmapel_rabu[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjadwalprioritas->NIP) && (@$tabel_jadwalmapel_rabu[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjadwalprioritas->id_namamapel)) { 
                              echo '<th bgcolor="'.@$rowjadwalprioritas->warna.'">'.$rowjadwalprioritas->Nama."(".$rowjadwalprioritas->nama_panggilan.")".'</th>'; 
                          }
                        }
                      }
                      ...
                      foreach (@$tabel_jammengajar as $rowjammengajar) {
                        ...
                        if ($ada == false) {
                          if ((@$tabel_jadwalmapel_rabu[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_rabu[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { 
                            echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama_mapel."(".$rowjammengajar->nama_panggilan.")".'</th>';  
                        }
                      }
                    }
                    ...
                    <td class="putih">
                      ...
                      foreach (@$tabel_jadwalprioritas_kamis[$i] as $rowjadwalprioritas) {
                        ...
                        if ($ada == false) {
                          if ((@$tabel_jadwalmapel_kamis[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjadwalprioritas->NIP) && (@$tabel_jadwalmapel_kamis[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjadwalprioritas->id_namamapel)) { 
                            echo '<th bgcolor="'.@$rowjadwalprioritas->warna.'">'.$rowjadwalprioritas->Nama."(".$rowjadwalprioritas->nama_panggilan.")".'</th>'; 
                        }
                      }
                    }
                    ...
                    foreach (@$tabel_jammengajar as $rowjammengajar) {
                      ...
                      if ($ada == false) {
                        if ((@$tabel_jadwalmapel_kamis[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_kamis[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { 
                          echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama_mapel."(".$rowjammengajar->nama_panggilan.")".'</th>';  
                      }
                    }
                  }
                  ...
                  <td class="putih">
                    ...
                    foreach (@$tabel_jadwalprioritas_jumat[$i] as $rowjadwalprioritas) {
                      ...
                      if ($ada == false) {
                        if ((@$tabel_jadwalmapel_jumat[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjadwalprioritas->NIP) && (@$tabel_jadwalmapel_jumat[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjadwalprioritas->id_namamapel)) { 
                          echo '<th bgcolor="'.@$rowjadwalprioritas->warna.'">'.$rowjadwalprioritas->Nama."(".$rowjadwalprioritas->nama_panggilan.")".'</th>'; 
                      }
                    }
                  }
                  ...
                  foreach (@$tabel_jammengajar as $rowjammengajar) {
                    ...
                    if ($ada == false) {
                      if ((@$tabel_jadwalmapel_jumat[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_jumat[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { 
                        echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama_mapel."(".$rowjammengajar->nama_panggilan.")".'</th>';  
                    }
                  }
                }
                ...
                <td class="putih">
                  ...
                  foreach (@$tabel_jadwalprioritas_sabtu[$i] as $rowjadwalprioritas) {
                    ...
                    if ($ada == false) {
                      if ((@$tabel_jadwalmapel_sabtu[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjadwalprioritas->NIP) && (@$tabel_jadwalmapel_sabtu[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjadwalprioritas->id_namamapel)) { 
                        echo '<th bgcolor="'.@$rowjadwalprioritas->warna.'">'.$rowjadwalprioritas->Nama."(".$rowjadwalprioritas->nama_panggilan.")".'</th>'; 
                    }
                  }
                }
                ...
                foreach (@$tabel_jammengajar as $rowjammengajar) {
                  ...
                  if ($ada == false) {
                    if ((@$tabel_jadwalmapel_sabtu[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_sabtu[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { 
                      echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama_mapel."(".$rowjammengajar->nama_panggilan.")".'</th>';  
                  }
                }
              }
              ...
              <td class="putih">
                ...
                foreach (@$tabel_jadwalprioritas_minggu[$i] as $rowjadwalprioritas) {
                  ...
                  if ($ada == false) {
                    if ((@$tabel_jadwalmapel_minggu[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjadwalprioritas->NIP) && (@$tabel_jadwalmapel_minggu[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjadwalprioritas->id_namamapel)) { 
                      echo '<th bgcolor="'.@$rowjadwalprioritas->warna.'">'.$rowjadwalprioritas->Nama."(".$rowjadwalprioritas->nama_panggilan.")".'</th>'; 
                  }
                }
              }
              ...
              foreach (@$tabel_jammengajar as $rowjammengajar) {
                ...
                if ($ada == false) {
                  if ((@$tabel_jadwalmapel_minggu[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_minggu[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { 
                    echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama_mapel."(".$rowjammengajar->nama_panggilan.")".'</th>';  
                }
              }
            }
