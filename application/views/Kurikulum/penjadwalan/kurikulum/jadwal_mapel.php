                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    <div style="padding : 20px;">
                      <form style="width:800px;margin:auto;" method="post" action="<?php echo site_url('kurikulum/simpanjadwalgurukurikulum'); ?>">
                        <div class="row">
                          <div class="col-md-6">
                              ...
                              <div class="form-group">
                                ...
                                <select data-placeholder="Pilih" class="kodeguru form-control" name="mapel" id="mapel">
                                  ...
                                  foreach (@$tabel_jadwalprioritas_senin[$i] as $rowjadwalprioritas) {
                                    ...
                                    if ($ada == false) {
                                      ?>
                                      <option class="kuning" value="<?php echo $rowjadwalprioritas->NIP; ?>_<?php echo $rowjadwalprioritas->id_namamapel; ?>" 
                                        <?php if ((@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjadwalprioritas->NIP) 
                                          && (@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjadwalprioritas->id_namamapel)) { 
                                            echo " selected"; } ?>>
                                            <?php echo $rowjadwalprioritas->Nama; ?>(<?php echo $rowjadwalprioritas->nama_panggilan; ?>)</option>
                                            <?php
                                          }
                                        }
                                        ?>
                                        ...
                                        foreach (@$tabel_jammengajar as $rowjammengajar) {
                                          ...
                                          if ($ada == false && $rowjammengajar->nama_panggilan !== null && $rowjammengajar->nama_panggilan !== '' &&  $rowjammengajar->nama_mapel !== null) {
                                            ?>
                                            <option style="background-color: <?php echo $rowjammengajar->warna; ?>"  class="putih" value="<?php echo $rowjammengajar->NIP; ?>_<?php echo $rowjammengajar->id_namamapel; ?>"
                                             <?php if ((@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) 
                                               && (@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) {
                                                echo " selected"; } ?>>
                                                <?php echo $rowjammengajar->nama_mapel; ?>(<?php echo $rowjammengajar->nama_panggilan; ?>)
                                              </option>
                                              <?php
                                            }
                                          }
                                  ...
                                  <tr>
                                    ...
                                    foreach ($tabel_kelasreguler as $key => $row_kelasreguler) {
                                      ...
                                      foreach (@$tabel_jadwalprioritas_senin[$i] as $rowjadwalprioritas) {
                                        ...
                                        if ($ada == false) {
                                          if ((@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjadwalprioritas->NIP) && (@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjadwalprioritas->id_namamapel)) {
                                    ...
                                    foreach (@$tabel_jammengajar as $rowjammengajar) {
                                      ...
                                      if ($ada == false) {
                                        if ((@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { 
                                          echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama_mapel."(".$rowjammengajar->nama_panggilan.")".'</th>';  $sudah = true;
                                      }
                                    }
                                  }
                                ...
                                <div class="row">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="row">
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="mapel">Mapel & Gurux</label>
                                          <select data-placeholder="Pilih" class="kodeguru form-control" name="mapel" id="mxapel">
                                            <option value="">Pilih Guru</option>
                                            <?php 
                                            foreach (@$tabel_jadwalprioritas_senin[$i] as $rowjadwalprioritas) {
                                              $ada = false;
                                              ...
                                              if ($ada == false) {
                                                ?>
                                                <option value="<?php echo $rowjadwalprioritas->NIP; ?>_<?php echo $rowjadwalprioritas->id_namamapel; ?>"
                                                 <?php if ((@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjadwalprioritas->NIP) && (@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjadwalprioritas->id_namamapel)) { echo " selected"; } ?>>
                                                 <?php echo $rowjadwalprioritas->Nama; ?>(<?php echo $rowjadwalprioritas->nama_panggilan; ?>)</option>
                                                 <?php
                                               }
                                             }
                                             ...
                                             foreach (@$tabel_jammengajar as $rowjammengajar) {
                                              ...
                                              if ($ada == false) {
                                                ?>
                                                <option value="<?php echo $rowjammengajar->NIP; ?>_<?php echo $rowjammengajar->id_namamapel; ?>" 
                                                  <?php if ((@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) 
                                                  && (@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo " selected"; } ?>>
                                                  <?php echo $rowjammengajar->nama_mapel; ?>(<?php echo $rowjammengajar->id_namamapel; ?>)
                                                </option>
                                                <?php
                                              }
                                            }
                    ...
                    <script type="text/javascript">
                      ...
                      $('#mapel').on('change', function() {
                        ...
                        if(mapel != '' && mapel != null) {
                          ...
                          console.log(mapel);
                          $.ajax({
                            url: '<?php echo site_url('kurikulum/getHariGuru'); ?>/'+mapel,
                            dataType: 'json',
                            cache: false,
                            success: function(msg){
                              let el = `<option value="">Pilih Hari </option>`;
                              console.log(msg)
                              for (const row of msg.data) {
                                el += `<option value="${row.nama}">${row.hari} </option>`
                              }
                      ...
                      if(hari != '' && hari != null ) {
                        ...
                        $.ajax({
                          url: '<?php echo site_url('kurikulum/getJamKeMapelHari'); ?>/'+mapel+'/'+hari,
                          dataType: 'json',
                          cache: false,
                          success: function(msg){
                            let el = ""
