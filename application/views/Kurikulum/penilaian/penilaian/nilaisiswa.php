  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          <center style="color:navy;">Nilai Siswa SMP Yogyakartax <br></center>
                  ...
                  <div class="box">
                    ...
                    <div class="box-body">
                      ...
                      <form method="post" action="<?php echo base_url('penilaian/penilaian/tambah_nilai'); ?>" onsubmit="return ceknilai();">
                        <select id="pilihkelastambah" 
                        onchange="document.location='<?php echo site_url('penilaian/penilaian/nilaisiswa'); ?>/'+document.getElementById('pilihkelastambah').value+'/'+document.getElementById('pilihmapeltambah').value;">
              ...
              <div class="bigbox-mapel"> 
                <div class="box-mapel">
                  ...
                  <div class="col-md-12">
                    ...
                    <select nama="id_kelas_reguler_berjalan2" id="imporkelasnilai" 
                    onchange="document.location='<?php echo site_url('penilaian/penilaian/nilaisiswa'); ?>/'+document.getElementById('imporkelasnilai').value+'/'+document.getElementById('impormapel').value;">
                    <option value="">Pilih Kelas</option>
                    <?php
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  foreach($nilai_siswa as $f) {
                    ...
                    ?>
                    <?php if (($this->session->userdata("jabatan") == "Kurikulum") || ($this->session->userdata("jabatan") == "Guru")) {
                      echo "<td>";
                      ?>
                      <a data-toggle="modal" data-show="true" data-target="#modal_nilai_<?php echo $f->id_nilai_siswa; ?>" class="btn btn-block btn-primary button-action btnedit" href="<?php echo base_url("penilaian/penilaian/form_edit_nilai/".$f->id_nilai_siswa); ?>" >Edit</a>

                      <a type="button" style="background: red ; border: red;" class="btn btn-block btn-primary button-action btnhapus " href="<?php echo base_url("penilaian/penilaian/hapus_nilai/".$f->id_nilai_siswa); ?>" onclick="return confirm_delete();">Hapus</a>

                      
                    <?php echo "</td>"; } ?>
                    <div id="modal_nilai_<?php echo $f->id_nilai_siswa; ?>" class="modal fade " role="dialog">
